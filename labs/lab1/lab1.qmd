...
::: {.callout-caution collapse="true" title="Click for Code"}
  // Lindsey Sands
  // lsands@g.hmc.edu
  // 09-06-2026
...
# Block Diagram 
![Figure 3: Block diagram](images/new_block.jpeg){width=80%}
...
::: {.callout-caution collapse="true" title="Click for Questa Simulation"}
![Figure 7: Counter Enable Questa Simulation](images/counter_enable_new.png){width=100%}
:::
...
## Conclusion
After much trial and error, everything worked. the LED blinked and the seven segment display was controllable. I spent about 30-35 hours on this lab.

## AI Prototype Summary

I gave ChatGPT the promtp and it gave me this code:
